...
export async function runModelRemovalContractInBrowser(): Promise<ModelRemovalContractResult> {
  ...
  const removedImageGeneration = await browserSetup.removeModel(imageGenerationModel.IMAGE_GENERATION_MODEL_ID);

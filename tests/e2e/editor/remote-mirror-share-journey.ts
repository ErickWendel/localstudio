...
export const remoteMirrorShareJourney = {
  async run(context: BrowserContext, page: Page, baseURL: string): Promise<void> {
    ...
    await installRemoteShareRoutes(context);
    ...
    await verifyPublicView(context, publicUrl);
    ...
    await verifyEmbedView(context, embedSrc!);
  },
};

async function installRemoteShareRoutes(context: BrowserContext): Promise<void> {
...
async function verifyPublicView(context: BrowserContext, publicUrl: string): Promise<void> {
...
async function verifyEmbedView(context: BrowserContext, embedSrc: string): Promise<void> {

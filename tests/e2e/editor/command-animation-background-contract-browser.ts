...
export type CommandAnimationBackgroundContractResult = {
  animationBuilds: unknown;
  background: unknown;
  transitionBeforeClear: unknown;
};

export async function evaluateCommandAnimationBackgroundContract(
  initialProject: ProjectDocument,
): Promise<CommandAnimationBackgroundContractResult> {

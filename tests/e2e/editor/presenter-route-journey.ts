...
export async function runPresenterRouteJourney(page: Page, baseURL: string): Promise<void> {
  ...
  await dismissPresenterIntro(page);

  await verifyInitialPresenterState(page);
  await verifyNotesResizer(page);
  await verifyTimerCommands(page);
  await verifyNotesSync(page);
  await verifyRemotePanelAndShortcuts(page);
  await verifyRouteNavigation(page);
  await verifyCommandHistory(page);
}

async function dismissPresenterIntro(page: Page): Promise<void> {
...
async function verifyInitialPresenterState(page: Page): Promise<void> {
...
async function verifyNotesResizer(page: Page): Promise<void> {
...
async function verifyTimerCommands(page: Page): Promise<void> {
...
async function verifyNotesSync(page: Page): Promise<void> {
...
async function verifyRemotePanelAndShortcuts(page: Page): Promise<void> {

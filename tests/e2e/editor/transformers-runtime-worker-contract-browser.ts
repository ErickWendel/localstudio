...
export type TransformersRuntimeContractResult = {
  detectedLanguage: unknown;
  generatedText: string;
  segmentationScore: number;
  workerProgressEvents: Array<{ details?: unknown; progress: number }>;
  workerRequests: string[];
};

export async function evaluateTransformersRuntimeWorkerContract(): Promise<TransformersRuntimeContractResult> {

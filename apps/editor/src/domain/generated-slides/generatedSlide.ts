...
const GENERATED_SLIDE_TASKS_RESPONSE_SCHEMA = {
  type: 'object',
  additionalProperties: false,
...
const GENERATED_SLIDE_ELEMENT_RESPONSE_SCHEMA = {
  oneOf: [
    {
      type: 'object',
      additionalProperties: false,
...
function parseGeneratedSlideTasksJson(value: string): GeneratedSlideTasksDocument {
...
function parseGeneratedSlideElementJson(value: string): GeneratedSlideElement {
  return normalizeElement(JSON.parse(extractJson(value)) as unknown);
}

export const generatedSlide = {

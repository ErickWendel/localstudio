...
const VALID_IMAGE_DIMENSIONS = new Set(imagePromptOptions.imageSizePresets.flatMap((preset) => [preset.width, preset.height]));
...
function createProjectSnapshot(state: EditorAutomationState): ProjectSnapshot {
  return {
...
export const editorAutomationController = {

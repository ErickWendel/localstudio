...
function normalizeSlideTasksForLayout(
  document: GeneratedSlideTasksDocument,
  userPrompt: string,
): GeneratedSlideTasksDocument {
...
function applySlideElementLayoutPreset(
...
export const slideLayoutPresets = {
  normalizeSlideTasksForLayout,
  applySlideElementLayoutPreset,
};

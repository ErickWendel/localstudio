import type { CropRect, ImageElement } from '../../../domain/documents/model';
...
function getImageCrop(element: ImageElement): CropRect {
  return normalizeCrop(element.crop ?? DEFAULT_CROP);
}

function calculateImageCropPatch(

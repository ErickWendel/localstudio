...
export function isDesignElement(element: DesignElement | undefined): element is DesignElement {
  return Boolean(element);
}

export function getElementLabel(element: DesignElement | undefined) {
...
export function getPolygonPoints(shape: ShapeElement['shape'], width: number, height: number) {
...
export function getShapePaint(element: ShapeElement) {

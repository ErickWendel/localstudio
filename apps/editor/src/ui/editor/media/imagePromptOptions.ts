...
const imageSizePresets: Array<{ label: string; width: number; height: number }> = [
...
const defaultCreateImagePromptOptions: CreateImagePromptOptions = {
  width: 512,
  height: 512,
  steps: 4,
};

function getImageSizeLabel(options: Pick<CreateImagePromptOptions, 'height' | 'width'>) {

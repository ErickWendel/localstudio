  ...
  return (
    <section id="demo" className="demo-section" aria-labelledby="demo-title">
      <Reveal as="div" className="section-heading" reveal="demo-heading">
        ...
        <h2 id="demo-title">From imported deck to editable slides, still local.</h2>
        <p>
          LocalStudio.dev keeps the core creation loop in the browser: import presentations, prompt, edit layers,
          translate, segment, generate, and save to disk.
        </p>
      </Reveal>
      <div className="demo-grid demo-grid--stair" aria-label="Watch workflow steps">
